...
with text:
  st.markdown('''
  - **Content Tagging Automation Platform(CTAP)** :Currently working with a top pharmaceutical company - Building a content tagging automation platform for improving marketing engagement with healthcare professionals (HCPs).
...
def load_bookspine():
  ...
  #st.image(book_spine_img, use_column_width ="always")
  small_text("[Book Shelf Digitization](https://github.com/sanchitgl/Bookshelf-digitization)", '''Web app that recognizes books in a book shelf image. Sements images by 
