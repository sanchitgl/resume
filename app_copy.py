...
with text:
  st.markdown('''
  - **Content Tagging Automation Platform(CTAP)** :Currently working with Merck & Co. - Building a content tagging automation platform for improving marketing engagement with healthcare professionals (HCPs).
